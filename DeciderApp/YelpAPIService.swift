...
class YelpAPIService {
    ...
    class func searchVenues(searchTerm: String) {
        ...
        let urlString = "\(kYelpAPIBaseSearchURL)term=\(searchTerm)&cll=47.621679,-122.319763&limit=\(kYelpAPISearchLimit)&oauth_consumer_key=\(kYelpAPIConsumerKey)&oauth_token=\(kYelpAPIToken)&oauth_signature_method=HMAC-SHA1&oauth_signature=\(kYelpAPITokenSecret.SHA1())&oauth_timestamp=\(timestamp)&oauth_nonce=oiwefoijwefoijwf"
